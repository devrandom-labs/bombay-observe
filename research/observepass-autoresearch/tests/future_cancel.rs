...
/// FINDING-001 — minimal reproducer. See RESEARCH-REPORT.md.
///
...
#[test]
#[ignore = "FINDING-001: sibling future cancellation steals the shared waker registration; survivor is never woken (0 wakes at completion)"]
...
/// FINDING-001 adjacent: same topology with three futures — cancelling any
/// one still disarms the survivors (the registration is not reference
/// counted).
#[test]
#[ignore = "FINDING-001 variant: same shared-waker deregistration defect with three futures; survivors get 0 wakes"]
